...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">LISTADO DE TABLA MASCOTA</h1>
        <div class="table-responsive-sm">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    $sql = $conexion->query("SELECT * FROM mascota");
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/mascota/actualizar.php?Id=<?php echo $resultado['idmascota'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?Id=<?php echo $resultado['idmascota'] ?>" class="btn btn-outline-danger">
